...
{     
    ...
    #endif
    {
        ...
        if
        (//(CANIF_CS_STARTED !=  CanIf_ControllerMode[CANIF_CANCONTROLLER_TX])   || jjq
        #if (CANIF_PDU_CHANNEL_MODE_CONTROL == STD_ON)
        ...
        {   
        	...
        	#endif
            {
                CanIfTxPduObject.swPduHandle = CanIfTxPduConfig[CanTxPduId].Hth % CAN_PER_CONTROLLER_MB_NUM;
                ...
                CanTxResult = Can_Write((CanIfTxPduConfig[CanTxPduId].Hth)/CAN_PER_CONTROLLER_MB_NUM, 
                                                             &CanIfTxPduObject);
