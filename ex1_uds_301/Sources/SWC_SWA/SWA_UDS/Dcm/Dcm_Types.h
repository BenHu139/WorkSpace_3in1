...
#define ADPT_UDS_34_SERVICE_IDEN_POS        (1)
#define ADPT_UDS_34_SERVICE_ADDRANDSIZE_POS (2)
#define ADPT_UDS_34_SERVICE_ADDRESS_POS     (3)
#define ADPT_UDS_34_SERVICE_SIZE_POS        (ADPT_UDS_34_SERVICE_ADDRESS_POS \
                                                + ADPT_MEMORY_ADDR_FORMAT)

#define ADPT_UDS_34_RESPONSE_FORMAT_POS     (1)
#define ADPT_UDS_34_RESPONSE_SIZE_POS       (2)
...
/* for 0x36  wen modify */
#define ADPT_UDS_36_SERVICE_INDEX_POS       (0x01u)
#define ADPT_UDS_36_SERVICE_DATA_POS        (0x02u)
